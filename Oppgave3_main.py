...
jVals08 = runSimulationVectorized(grid, initialPositions3a, beta_k, alpha, N_x, N_p, T_p, totalSteps, True)
...
#Tid
T_pArray = np.arange(1, 2001, 40)    #Liste med ulike tidsepoker
